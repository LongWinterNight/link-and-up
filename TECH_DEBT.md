...
## Фаза 2: i18n-хвосты → блокирует EN-локализацию

> Без этого EN-переключатель неполон — пользователь видит русские строки
> в модалках, ошибках, audit log, карточке и гардрейлах.
...
> Текущее покрытие: 91.91% lines / 85.67% branches / 86.75% functions.
> Слабые места: shareCard (35%), exports branches (47%), persistCore (0 тестов).
